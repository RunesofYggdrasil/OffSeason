...
var highlighted_item: Node2D = null
...
func get_item_children() -> Array[Node2D]:
	var item_children: Array[Node2D] = []
...
func get_next_item(direction: INPUT_DIRECTION) -> Node2D:
	if direction == INPUT_DIRECTION.PREV or direction == INPUT_DIRECTION.NEXT:
		return null
...
func get_next_tab_item(direction: INPUT_DIRECTION) -> Node2D:
	if direction != INPUT_DIRECTION.PREV and direction != INPUT_DIRECTION.NEXT:
		return null
	var item_children: Array[Node2D] = get_item_children()
